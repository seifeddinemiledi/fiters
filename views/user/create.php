                                    ...
                                    <form  method="post" enctype="multipart/form-data" class="form-horizontal ">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-9">
                                                <div class="radio">
                                                    <label for="radio1">
                                                        <input type="radio" required id="radio1" name="gender" value="0">0
                                                    </label>
                                                </div>
                                                <div class="radio">
                                                    <label for="radio2">
                                                        <input type="radio" required id="radio2" name="gender" value="1">1
                                                    </label>
                                                </div>
                                                <div class="radio">
                                                    <label for="radio3">
                                                        <input type="radio" required id="radio3" name="gender" value="2">2
                                                    </label>
                                                </div>
                                            </div>
                                        </div>
